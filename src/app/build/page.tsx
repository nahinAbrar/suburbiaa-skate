...
export default async function Page(props: {searchParams: Promise<SearchParams>}) {
    ...
    const defaultTruck = metals.find((truck) => truck.uid === searchParams.truck) ?? metals[0]
    const defaultBolt = metals.find((bolt) => bolt.uid === searchParams.bolt) ?? metals[0]
    ...
    return (
        <div className='flex min-h-screen flex-col lg:flex-row'>
            ...
            >
                ...
                <div className="grow bg-texture bg-zinc-900 text-white ~p-4/6 lg:shrink-0 lg:grow-0">
                    <Heading as="h1" size='sm' className='mb-6 mt-0' >Build Your Board</Heading>
