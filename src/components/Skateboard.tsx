...
export function Skateboard({ wheelTextureURLs, wheelTextureURL, deckTextureURLs, deckTextureURL, truckColor, boltColor, constantWheelSpin = false, }: SkateboardProps) {
