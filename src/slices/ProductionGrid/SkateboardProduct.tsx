...
const HORIZONTAL_LINE_CLASSES = "-mx-8 top-0 stroke-2 text-stone-300 transition-colors group-hover:text-stone-400"
    ...
    return (
        <div className='group relative mx-auto w-full max-w-72 px-8 pt-4'>
            ...
            <div className='-mb-1 overflow-hidden py-4'>
                ...
                <Scribble className='absolute bottom-0 inset-0 h-full w-full' color={dominantColor} />
