...
/**
 * Props for `ProductionGrid`.
 */
export type ProductionGridProps =
  SliceComponentProps<Content.ProductionGridSlice>;

/**
 * Component for "ProductionGrid" Slices.
 */
const ProductionGrid: FC<ProductionGridProps> = ({ slice }) => {
  return (
    <Bounded
